...
export class Migration1694227129956 implements MigrationInterface {
    name = 'Migration1694227129956'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TYPE "public"."users_role_enum_old" AS ENUM('CUSTOMER', 'ADMIN', 'SUPERADMIN')
        `);
        await queryRunner.query(`
            ALTER TABLE "users"
